...
This fork also focuses on integrating nicely with Atlasian products (Bitbucket, Jira, etc.), since I have to use them for work and haven't found a good desktop client for it.
